...
<head>
    ...
    <title>Tenant Suggestion - Trinidad Boarding House</title>
    <style>
        body {
...
<body>
    ...
    <h1>Submit Tenant Suggestion</h1>
    ...
    <a href="{{ route('tenant.dashboard') }}" style="display: block; margin-top: 20px; text-align:center; color:#1abc9c;">
