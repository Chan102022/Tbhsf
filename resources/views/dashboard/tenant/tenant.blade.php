...
<head>
  ...
  <title>Trinidad Boarding House | Tenant Dashboard</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="main-container">
    <!-- Sidebar for Tenant Dashboard -->
    <aside class="sidebar">
      <h3>Tenant Menu</h3>

      <div class="dropdown">
        <button class="dropdown-btn">My Room</button>
      ...
      <div class="dropdown">
        <button class="dropdown-btn">Payments</button>
        <div class="dropdown-content">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="#">Billing Summary</a>
          <a href="#">Complaint Reports</a>
        </div>
      </div>

      <div class="dropdown">
        <button class="dropdown-btn">Messages</button>
        <div class="dropdown-content">
          <a href="#">Inbox</a>
    ...
    <!-- Tenant Dashboard Main Content -->
    <div class="content">
      <div class="card">
        <h2>Tenant Dashboard</h2>
        <p>Manage your bookings, payments, and maintenance requests easily.</p>
      </div>

      <div class="card">
        <h2>Overview</h2>
        <ul>
          <li>Current Balance / Rent Due: 0</li>
          <li>Room Number: 0</li>
          <li>Maintenance Requests: 0</li>
        </ul>
      </div>
    </div>
  </div>
