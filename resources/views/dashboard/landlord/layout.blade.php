...
<head>
    ...
    <title>Trinidad Boarding House - Landlord</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        button.action-btn:hover, a.back-btn:hover { 
            background-color: #37b6e8ff; 
...
<body>
    ...
    <nav>
        <a href="{{ route('landlord.dashboard') }}" class="{{ Request::routeIs('landlord.dashboard') ? 'active' : '' }}">Home</a>
